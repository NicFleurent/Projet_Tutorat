...
const DrawerList = [
    ...
    {icon: 'person-circle', label: 'Modifier le compte', navigateTo:'Modification du compte'},
    {icon: 'settings', label: 'Changer le mot de passe', navigateTo:'Modification du compte'}
]
